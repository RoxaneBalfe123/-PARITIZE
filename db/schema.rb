...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2022_02_24_182407) do
=======
ActiveRecord::Schema.define(version: 2022_02_24_184921) do
>>>>>>> master
  ...
  create_table "gender_ratings", force: :cascade do |t|
    t.float "c_rating"
    t.float "mid_rating"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_id"], name: "index_gender_ratings_on_company_id"
  end
  ...
  add_foreign_key "gender_ratings", "companies"
end
